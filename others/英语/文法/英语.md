...
- [作为形容词](./不定词.md#作为形容词)
- [作为副词](./不定词.md#作为副词)
- [含有不定词的句型](./不定词.md#含有不定词的句型)
- [不定词和时态](./不定词.md#不定词和时态)
- [特别注意的不定词用法](./不定词.md#特别注意的不定词用法)
- - - 
...
- can (could) 表“能力、许可、可能”
	...
	- 表“能力” = be able to
			...
			他能说日语，但是不会写。
			cannot = can not = can't 不用缩写的原因是尾音比较轻，避免混淆。cannot 不能放句首或句尾，只能放句子中间
	...
	- 表“许可”
			...
			Can I leave early because I'm not well today. 
			Certainly.
			因为我今天不舒服，我能早点离开吗?

			Can I come in?
			Could I come in?
			could 的语气更客气，不是 can 的过去式。如果是平辈或晚辈可以用 can I，如果是长辈或上司要用 could I
			如果是询问对方使用 can you 就可以
...
- 限定和非限定用法
	...
	2. 非限定用法
		...
		关代不能用 that 代替，受格关代不能省略
			...
			My brother, who is a dentist, is studying in the U.S..
			我哥哥是牙医，他正在美国学习.

- 关系代名词的同义表现

	1. 名词（先行词） + 关代 + V. = 名词 + 现在分词（主动）
	...
	2. 名词 + 主格关代 + beV. + 过去分词 = 名词 + 过去分词（被动）

			This is a cake which Mrs.White made. （主动）
			This is a cake which was made by Mrs.White. （被动）
			This is a cake made by Mrs.White.
			这是由怀特太太所做的蛋糕。
			which was made by Mrs.White. 是形容词子句
			made by Mrs.White. 是形容词片语

	3. 名词 + who + have/has/had = 名词 + having/with(有)

			She is a girl who has blond hair.
			She is a girl having blond hair. （主动）
...
- be动词的间接问句
		...
		I have no idea who that tall girl is.
		我不知道那个高个子的女孩是谁。
		...
		你知道站在门口的女孩是谁吗？
		the girl 是主词，standing at the door 修饰主词，也算是主词的一部分，所以 is 要放在最后

		Where are you going with your mom?
		Tell me where you are going with your mom.
		告诉我你和你妈妈要去哪里。
		going 表示动作正在进行，所以间接问句要用 be + Ving
...
- 助动词的间接问句
	...
	有具体意思的助动词不能省略
		...
		How can the little boy move the large box?
		I wonder how the little boy can move the large box.
		我很怀疑这个小男孩怎么能搬动这个大箱子。
		no wonder 难怪
		惊奇的事物一般使用复数形式 wonders
...
- 疑问词为主词的间接问句
		...
		Who broke the antique vase?
		Do you know who broke the antique vase?
		你知道谁打破了古董花瓶吗？

		Nobody knows who cheated in/on the exam.
		没有人知道谁在考试时作弊。
		nobody = no one 动词使用单数形式

#### 特别注意的间接问句

- 含 do you think/guess/say 等间接问句

	如果是一般疑问句，回答和问题不匹配，需要把间接问句的疑问词放在句首

		Who will be sent to the United States? Do you think?
		Do you think who will be sent to the United States? (×)
		Who do you think will be sent to the United States? (✔️)
		你认为谁将会被派去美国？
		I think it will be Tom.
		我认为是 Tom.

		What time will the class begin? Do you say?
		Do you say what time the class will begin? (×)
		What time do you say the class will begin? (✔️)
		你说什么时候开始上课?
...
- 名词片语
	...
	疑问词 + 不定词 = 名词片语
		...
		she 与主要子句中的主语重复，可省略，主词省略动词也省略
		The poor girl doesn't know what to do.
		这可怜的女孩不知道她该做什么。
		what to do 是名词片语，由名词子句变化而来

		Who to bell the cat is a big problem. （主语）
		The big problem is who to bell the cat. (补语)
		We don't know who to bell the cat. （宾语）
		It is a big problem who to bell the cat. （形式主语）
		谁来担当这个危险的任务是个大问题。
	...
	Do you know 
		...
		where to go? 该去哪？
		who to ask?	该问谁？
		how to do it?	该怎么做？ how 是疑问副词，不能当受词，所以要 +it
		what to do?	 该怎么办？ what 是疑问代名词，可以当受词
...
3. 请告诉我们哪里可以买到手工皮鞋。
	...
	Please tell us where can buy the hand-made shoes. (×)

		此句中的间接问句缺少主词，不能用 can
		hand-made 手工的
		ready-made 现成的

	Please tell us where to buy the hand-made shoes. (√)

		间接问句缺少主词，使用 疑问词+不定词=名词片语 充当主语

4. 让我知道他是不是爱上 Amy 了。

	Let me know if he fell in love with Amy.
...
1. and
		...
		当个大学生和在大学求学是两回事。
		如果用 be 开头是祈使句，上面的例句并不包含希望、请求或命令的意思，所以要使用名词作主语
		对等连接词前面是 being，后面要使用 studying

		We can breathe/have fresh air and enjoy beautiful scenery.
		我们可以呼吸新鲜的空气和享受美丽的风景。
...
2. but
		...
		That little girl fell down but didn't cry.
		That little girl fell down, but she didn't cry.
		那个小女孩跌倒了，但没有哭。
		如果有 she，表示连接两个句子，要使用逗号隔开；如果省略 she，表示连接两个动作，不需要逗号

		My parents promised/agreed to let me go out with you, but they asked me to come/be home before twelve o'clock.
		我爸妈答应让我跟你出去，但是他们要求我必须在12点前回家。
		答应、让和出去是三个动词，其中第一个动词“答应”是本动词，表示时态；第二个动词“让”在本动词后，使用不定词的形式；第三个动词“出去”看第二个动词的形态，是动词原形，所以使用 go
		ask 后动词要使用不定词

3. or(或者；否则)

		What would/do you prefer, coffee or tea?
		你较喜欢哪一种，咖啡或茶？

		You can turn carbon into diamonds or (you can turn) sand into computer chips.
		你可以将碳转变成钻石或是将沙子转变成电脑晶片。
		把A转成B turn A into B. into 是转变的意思
...
4. so 只能连接子句
		...
		Some people never think of the future, so their things are used only once and thrown them away. (?)
		有些人不曾想过未来，所以他们的东西只用一次就丢弃。
		
		We share this world, so each of us has to do our part.
		我们共享这个世界，所以我们每个人都必须各尽本分。
		each of us 强调的是个体，所以动词用单数形式

- 对等相关连接词

	both\~and（\~和\~两者都）   
	not only\~but (also)\~/but\~as well （不仅\~而且\~)   
	either\~or\~ （不是\~就是\~）

		She hopes (both) to lose weight and (she hopes both to) shape up by jogging.
		她希望藉由慢跑减重和塑形。
		both 强调一举两得
		后面子句省略了hope，to 也跟着省略
		...
		不仅我而且他们也生你的气。
		not only\~but also 强调的是后者，动词以后面的主词为准，所以用 they are
		...
		王老师和学生们上课都迟到了。
		强调的是前者，as well as 是“和”的意思，第一个 as 是“一样”，第二个 as 是“像”，意思是像学生一样迟到了。与 and 不一样。

祈使句 + and（那么）/ so（否则）+ S + V

	Go to the shop right now, so it will be closed.
	Go to that book store, and you'll find foreign books.
...
- 子句的时态
	...
	- 名词子句
		...
		- that
			...
			当主语
				...
				She will come. It is almost certain.
				...
				全球气候变暖是毋庸置疑的。
				中括号中的句子为名词子句，由 that 引导，所以有两个 be 动词
			...
			当宾语 that 可以省略
				...
				He said (that) he was thinking about moving his office form Taipei to Kaohsiung.
				他说他正在考虑将办公室从台北搬到高雄去。
				名词子句当受词 that 可以省略

				I can't belive (that) he has made the same mistake three times.
				我真不敢相信他已经犯了三次相同的错误。

			有 and、but 等连接词时，第二个 that 不能省略

				Mother said (that) you stayed at home and that you had to do all housework.
				妈妈说你要待在家里，还说要做完所有家务。
				两个 that 表示都是妈妈说的话，如果省略了第二个 that，就不是妈妈对你说的了，而是对你转述的人说的话（姐姐假传圣旨）。

			同位语

				I heard the news that a new student would join our class.
				我听到一个消息，一个新同学将要加入我们班。
				the news 和后面的子句是同位语，地位相同
				news 不可数名词
		...
		- if、whether
			...
			当主词
				...
				他来不来都没有差别。
				whether 引导的子句作为主词时不能用 if 代替
				whether...or not = whether = 表示“是否”
				no 后面接名词 
			...
			当补语
				...
				问题是我该买还是该租。
				whether 引导的子句作为补语时不能用 if 代替

			当受词，wheather 和 if 可以互换

				He asked me wheather/if it would be fine tomorrow.
				他问我明天天气怎么样。
	...
	- 副词子句
		...
		- 表示“时间”的副词子句
			...
			after、as、before、since、until、till、when、while、as soon as(一...就...)

				After I tell you the answer, please repeat it after me loudly.
				在我告诉你们答案之后，请大声的跟我复读一遍。

				Taking off the shoes is a custom before entering a Chinese house.
				It is a custom to take off the shoes before you go into a Chinese man's house.
				在进中国人的屋子之前先脱掉鞋子是个习俗。

				Heat the cookies at 350 degrees until/till they turn light brown.
				以350度来加热饼干直到呈现淡棕色。

				When you take medicine, be sure to follow the doctor's instructions/directions below.
				当你吃药时，务必遵照下述医师的指示。
				direction 表示“方向”，当表示“指示”时，必须使用复数形式
		...
		- 表示“原因”的副词子句
				...
				Because I am very tired, I don't go.
				I didn't go because I was exhausted(精疲力尽).
				I was exhausted, so I didn't go.
				因为我非常累了，所以我没去。
				so 是对等连接词，只能连接子句，并且要加逗号

				I always like to buy cakes in that bakery because they are twenty percent off after eight o'clock in the evening.
				我总是喜欢到那家面包店买蛋糕，因为晚上8点后打8折。
				时间顺序是由小到大
				打八折 = 去掉20% = twenty percent off

				We ate lunch in the garden since it was nice and cool outside.
				因为室外天气宜人凉爽，我们在花园吃午餐。

				Today is Sunday, so there are few students on the bus.
			...
			必须用 because
				...
				He is absent not because he is busy but because he is ill.
				他缺席不是因为他忙，而是因为他病了。
		...
		- 表示“条件”的副词子句
			...
			if（如果）
				...
				If you keep eating fast food, you will taste the bitter fruits soon after/before long.
				如果你继续吃速食，不久你就会尝到苦果。
				主要子句是将来时，副词子句要使用现在时
				fruit 表示“水果”时是不可数名词，表示“成果”时必须 +s，苦的成果即苦果
		
		- 表示“让步”的副词子句

			though、although、whether...or not(无论是否)

				Though/Although Taiwan is small, I love it. After all, it is my homeland.
				Taiwan is small, but I love it. After all, it is my homeland.
				虽然台湾很小，但是我爱它。毕竟，他是我的故乡。

				Although she is a teacher, she isn't patient with children.
				Teacher as she is, she isn't patient with children. （旧式英语）
				虽然她是一个老师，但是她对孩子没有耐心。
				as 前面可以是形容词、副词或名词，前面为名词时不能加冠词

				Whether it rains or not, the final game will be played.
				无论是否下雨，决赛都将进行。
				这里的 whether...or not 引导的是副词子句，不能用 if 代替 whether
				主要子句是将来时，副词子句用现在时
		...
		- 表“结果、目的”的副词子句
			...
			so...that...、so that
				...
				这个东西太重了我们搬不动。
				that 连接子句时，受词不能省略；不定词后面的受词如果和主词一致必须要省略
				...
				这个发型如此的酷，我想要模仿。
				so 是副词，后面可以接形容词或副词；such 是形容词，后面接名词
...
- at + 时刻、年龄、正午、半夜
		...
		She is at the age of eleven.
		她11岁了。

		My English class begins at eight o'clock.
		我的英文课在8点开始。

- on + 特定的日期（生日、国庆节等）、星期几、几月几日
...
- 时间名词前加 last、next、this、that 时组成时间副词，不可再搭配介词
...
- before、by
		...
		Please arrive by ten o'clock.
		Please arrive before ten o'clock.
		请在10点前到达。
		by = not later than = <= 表示在10点及10点之前都可以
		before = earlier than = < 表示必须在10点之前，如果正好10点就晚了
...
- in、within
	...
	within 表示在时间期限之内
		...
		He'll come back whitin an hour.
		他一个小时之内会回来。

- for、during

	for 表示持续的时间长度；during 表示在某段时间当中的某个时间点
...
- at、in、on
	...
	- at 
		...
		确切的地点；门牌号
			...
			He lives at 75 Roosevelt road Taipei.
			他住在台北的罗斯福路75号。
			多个地点顺序是由大到小，介词以小地点为准，就近原则
...
- on、above、over、under、below
	...
	above：表示不接触而高于某样事物的表面，此时也可以用 over

		She held an umbrella above/over her daughter's head.
		她在她女儿的头顶上撑了一把伞。
	...
	below 为 above 的反义词
		...
		There is usually a supermarket over a department store.
		百货商店下面通常有超市。
...
- between、among
	...
	among：在三者或三者以上之中
		...
		She failed to find her little brother among the crowd.
		她未能在人群中找到他的弟弟。
		fail to V 未能
...
- in front of、in the front of、in back of、in the back of、behind
	...
	in back of = behind  反义词 in front of
...
- along、across、through
		...
		Our train is running throught a tunnel.
		我们的火车正在穿过隧道。
...
- in
	...
	在...之后(时间)
		...
		She will get well in a week or so.
		她一周左右就会好的。
		or so 大约
...
- by
	...
	只差...(表差异或程度)
		...
		He is older thant I by two years.
		他比我大两岁。
