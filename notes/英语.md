...
- 受词
	...
	- 只能使用不定词的动词 decide、hope、want、expect、volunteer等
			...
			I want to see a move with my friends.
			我想要和我的朋友们一起去看电影。
			I want to watch a film with my friends tomorrow.
			我明天想要和我朋友们一起去看电影。
			时态还是要使用现在式，看电影的动作是将来式，而想的动作是现在做的
			[watch a film] = [see a movie] 看电影
			[would like] 可以替换 want，语气更客气，对长辈讲话时最好用 [wold like]
...
- 作为主语
		...
		Doing it right now is important.
		To do it right now is important.
		立刻做这件事是重要的。
